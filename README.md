...
This curated list contains 140 awesome open-source projects with a total of 120K stars grouped into 30 categories. All projects are ranked by a project-quality score, which is calculated based on various metrics automatically collected from GitHub and different package managers. If you like to add or update projects, feel free to open an [issue](https://github.com/tolkonepiu/best-of-nix/issues/new/choose), submit a [pull request](https://github.com/tolkonepiu/best-of-nix/pulls), or directly edit the [projects.yaml](https://github.com/tolkonepiu/best-of-nix/edit/main/projects.yaml). Contributions are very welcome!
...
- [Channel History](#channel-history) _0 projects_
...
- [Arduino (Programming Languages)](#arduino-programming-languages) _1 projects_
- [Clojure (Programming Languages)](#clojure-programming-languages) _1 projects_
- [Crystal (Programming Languages)](#crystal-programming-languages) _1 projects_
- [Elm (Programming Languages)](#elm-programming-languages) _1 projects_
- [Gleam (Programming Languages)](#gleam-programming-languages) _1 projects_
- [Haskell (Programming Languages)](#haskell-programming-languages) _5 projects_
- [Haxe (Programming Languages)](#haxe-programming-languages) _2 projects_
- [Lean (Programming Languages)](#lean-programming-languages) _1 projects_
- [Node.js (Programming Languages)](#nodejs-programming-languages) _3 projects_
- [OCaml (Programming Languages)](#ocaml-programming-languages) _1 projects_
- [PHP (Programming Languages)](#php-programming-languages) _5 projects_
- [PureScript (Programming Languages)](#purescript-programming-languages) _2 projects_
- [Python (Programming Languages)](#python-programming-languages) _1 projects_
- [Ruby (Programming Languages)](#ruby-programming-languages) _2 projects_
- [Rust (Programming Languages)](#rust-programming-languages) _8 projects_
- [Scala (Programming Languages)](#scala-programming-languages) _1 projects_
- [Zig (Programming Languages)](#zig-programming-languages) _2 projects_
...
- [GitHub](https://github.com/danth/stylix) (👨‍💻 130 · 🔀 210 · 📋 480 - 32% open · ⏱️ 06.05.2025):
