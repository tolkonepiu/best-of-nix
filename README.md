...
This curated list contains 2 awesome open-source projects with a total of 9 stars grouped into 18 categories. All projects are ranked by a project-quality score, which is calculated based on various metrics automatically collected from GitHub and different package managers. If you like to add or update projects, feel free to open an [issue](https://github.com/tolkonepiu/best-of-nix/issues/new/choose), submit a [pull request](https://github.com/tolkonepiu/best-of-nix/pulls), or directly edit the [projects.yaml](https://github.com/tolkonepiu/best-of-nix/edit/main/projects.yaml). Contributions are very welcome!

> 🧙‍♂️  Discover other [best-of lists](https://best-of.org) or [create your own](https://github.com/best-of-lists/best-of/blob/main/create-best-of-list.md).

## Contents

- [Learning](#learning) _0 projects_
- [Nix Configurations](#nix-configurations) _0 projects_
- [Discovery](#discovery) _0 projects_
- [Installation Media](#installation-media) _0 projects_
- [Github Actions](#github-actions) _0 projects_
- [Deployment Tools](#deployment-tools) _1 projects_
- [Virtualisation](#virtualisation) _0 projects_
- [Command-Line Tools](#command-line-tools) _0 projects_
- [AI Tooling](#ai-tooling) _0 projects_
- [Development](#development) _1 projects_
- [DevOps](#devops) _0 projects_
- [Programming Languages](#programming-languages) _0 projects_
- [NixOS Modules](#nixos-modules) _0 projects_
- [Theming](#theming) _0 projects_
- [Overlays](#overlays) _0 projects_
- [Security](#security) _0 projects_
- [Editors and IDEs](#editors-and-ides) _0 projects_
- [Distributions](#distributions) _0 projects_
